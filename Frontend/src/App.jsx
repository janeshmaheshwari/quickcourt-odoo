    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-700">Loading QuickCourt...</h2>
        ...
        <footer className="bg-gray-900 text-white py-12 mt-8">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                <h3 className="text-2xl font-bold text-yellow-400 mb-4">QuickCourt</h3>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="/venues" className="text-gray-300 hover:text-yellow-400">Venues</a></li>
                  <li><a href="/login" className="text-gray-300 hover:text-yellow-400">Login</a></li>
                  <li><a href="/signup" className="text-gray-300 hover:text-yellow-400">Sign Up</a></li>
                </ul>
              </div>
              <div>
                <h4 className="text-lg font-semibold mb-4">Support</h4>
                <ul className="space-y-2">
                  <li><a href="#" className="text-gray-300 hover:text-yellow-400">Help Center</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-yellow-400">Contact Us</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-yellow-400">Privacy Policy</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-yellow-400">Terms of Service</a></li>
                </ul>
              </div>
              <div>
